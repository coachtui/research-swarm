...
export const PLANS: Record<PlanKey, Plan> = {
  starter: {
    ...
    description: 'Core analysis engine for investors getting started',
    popular: false,
    bullets: [
      '5 full analyses / month',
  ...
  investor: {
    ...
    description: 'Full decision intelligence for active investors',
    popular: true,
    bullets: [
      '15 full analyses / month',
      'Everything in Starter',
      'Probabilistic EV engine + scenario weights',
      'Stop probability & confidence calibration',
      'Full analyst verdict & investment thesis',
  ...
  trader: {
    ...
    description: 'Allocation & execution infrastructure for professionals',
    popular: false,
    bullets: [
      ...
      'Trade stability & correlation monitoring',
      'PDF report export',
    ],
    unlockedFeatures: [
      'historical_patterns',
