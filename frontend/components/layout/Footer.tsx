...
export function Footer() {
  return (
    <footer className="border-t border-surface-elevated bg-surface/50 mt-auto">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-6 border-t border-surface-elevated flex flex-col md:flex-row justify-between items-center">
